...
private:
    ...
    enum enMainMenueOptions { eListClients = 1, eAddNewClient = 2, eDeleteClient = 3, eUpdateClient = 4,
                              eFindClient = 5, eShowTransactionsMenue = 6, eShowManageUsersMenue = 7,
    ...
    static short _ReadMainMenueOption()
    {
        ...
        MainMenueOption = clsInputValidate<short>::ReadNumberBetween(1, 10, "Enter Number between 1 to 10?\n");
    ...
    {       
        clsFindClientScreen::ShowFindUserScreen();
    }
    ...
    static void _Logout()
    {
       ...
       /* clsLoginScreen::ShowLoginScreen(); It's impossible to do Circular Reference*/
    }
